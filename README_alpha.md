...
This script checks for updates on the IRCC portal and sends a notification if there is an update. It uses Selenium to automate a web browser and sends email and push notifications when updates are available. It is designed to be run periodically to ensure that you are notified of any updates as soon as possible.

## Overview

The IRCC (Immigration, Refugees and Citizenship Canada) Citizenship Portal is used by applicants to check the status of their immigration applications. This script automates the process of checking for updates on the IRCC portal and sends email and push notifications when updates are available.
